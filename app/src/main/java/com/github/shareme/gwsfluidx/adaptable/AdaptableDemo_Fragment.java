...
import com.github.shareme.gwsfluidx.binding.adaptable.AdaptOnDemandAdaptableBindingAdapter;
import com.github.shareme.gwsfluidx.binding.adaptable.AdaptableBindingAdapter;
import com.github.shareme.gwsfluidx.databinding.AdaptableListItemBinding;
...
public class AdaptableDemo_Fragment extends BaseFragment<AdaptableDemo_ViewModel> {
    ...
    return new AsyncTask<Void, Void, List<AdaptableDemo_ViewModel>>() {
      ...
      protected void onPostExecute(List<AdaptableDemo_ViewModel>
        ...
        BindingAdapter bindingAdapter =
                new BindingAdapter(getActivity(), adaptableViewModels, actualAdapter);
